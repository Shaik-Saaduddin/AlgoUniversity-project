...
SECRET_KEY = 'django-insecure-8v*eqi2uvjw)u!ym(1(^d!vos9-4o=2!=y7u$w$mk&)&-51)by'
...
ALLOWED_HOSTS = [
    ...
    'localhost',
    '127.0.0.1'
    # add your domain here if you have one
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'OnlineJudge', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
